...
The 29 on our list were decided by the role and impact each country has had upholding or at least indirectly supporting the liberal international order. Each country is here because its choices -- to defend the order, to hedge, or to defect -- carry the most consequence for the order's trajectory.
